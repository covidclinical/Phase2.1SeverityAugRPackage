#modified from https://github.com/cran/eRm/blob/b54bd5930675dcfab50a10ec401b4eefa2990c91/R/datprep_PCM.R
datprep_PCM <-
  function(X,BIDMC_PCM_model)
  {
    ...
    mt_vek <- apply(BIDMC_PCM_model$X,2,max,na.rm=TRUE)             #number of categories - 1 for each item
